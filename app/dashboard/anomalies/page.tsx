  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div className="border rounded-lg bg-card p-4"><p className="text-xs text-muted-foreground">Aperte</p><p className="text-2xl font-semibold">{openCount}</p></div>
        <div className="border rounded-lg bg-card p-4"><p className="text-xs text-muted-foreground">In lavorazione</p><p className="text-2xl font-semibold">{inProgressCount}</p></div>
        <div className="border rounded-lg bg-card p-4"><p className="text-xs text-muted-foreground">Chiuse</p><p className="text-2xl font-semibold">{closedCount}</p></div>
      </div>
