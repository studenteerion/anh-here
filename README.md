...
- **[ANH-here - Diagramma dei Casi d'Uso.pdf](./Diagrammi/ANH-here%20-%20Diagramma%20dei%20Casi%20d'Uso.pdf)** - Diagramma dei casi d'uso
- **[ANH-Here - Diagramma delle Classi.pdf](./Diagrammi/ANH-Here%20-%20Diagramma%20delle%20Classi.pdf)** - Diagramma delle classi
- **[SCENARIOS.md](./SCENARIOS.md)** - Scenari esaminati nel dettaglio

### Manuali
- **[MANUALE_UTENTE.md](./MANUALE_UTENTE.md)** - Guida per gli utenti finali
- **[MANUALE_SVILUPPATORE.md](./MANUALE_SVILUPPATORE.md)** - Guida per gli sviluppatori

### Pianificazione e Sviluppo
- **[DEVELOPMENT_ROADMAP.md](./DEVELOPMENT_ROADMAP.md)** - Roadmap dello sviluppo, features completate e future
- **[TESTING.md](./TESTING.md)** - Guida al testing del progetto
---
...
- **MySQL 2/Promise 3.19.0+**
### Database
- **MySQL** (Multi-tenancy architecture)
---
## Link Mockup
